...
const recentCommits: Commit[] = [
  ...
  {
    hash: '8ceff82',
    date: '2025-09-27T12:44:48+08:00',
    author: 'SerRodneyRich',
    title: 'Stripe Integration Updates',
    description: 'Updated Stripe payment integration with enhanced donation modal, improved button styling, and better thank-you page experience. Added comprehensive Stripe setup documentation.',
    type: 'feature',
    files: ['components/DonateButton.tsx', 'components/DonateModal.tsx', 'app/thank-you/page.tsx', 'components/VerticalMenu.tsx', 'STRIPE_SETUP.md'],
    impact: 'minor'
  },
  {
    hash: '0ca1c61',
